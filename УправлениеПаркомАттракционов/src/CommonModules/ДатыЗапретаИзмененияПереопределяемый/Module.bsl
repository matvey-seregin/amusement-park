...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
    ...
    Раздел.Имя  = "ОперативныйУчет";
    Раздел.Идентификатор = Новый УникальныйИдентификатор("5e0bd0fb-629f-4d0f-92a7-f324f35d0fb6");
    Раздел.Представление = НСтр("ru = 'Оперативный учет'");
    Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Филиалы"));	
